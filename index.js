		...
		try {
			...
			switch(command) {
				...
				case 'dono':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '*CRIADOR:* Premiiado\n*YOUTUBE:* https://youtube.com/premiiado\n*WPP:* wa.me/5562999397588\n*INSTA:* https://instagram.com/opremiiado\n\n\n'})
					break
				case 'belle2':
					memein = await kagApi.memeindo()
				...
				case 'canal':
					...
					client.sendMessage(from, buffer, image, {quoted: mek, caption: '️*Canal do Premiiado:*\n\n https://youtube.com/Premiiado'})
					break
				case 'mia1':
					memein = await kagApi.memeindo()
